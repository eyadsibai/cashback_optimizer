...
categories = {
    ...
    "online_shopping_local": Category(key="Online Shopping (Local)",
                                      display_name="Online Shopping (Local)"),
    "international_spend_non_eur": Category(key="International Spend (Non-EUR)",
                                            display_name="International Spend (Non-EUR)"),
    "other_local_spend": Category(key="Other Local Spend", display_name="Other Local Spend"),
}
